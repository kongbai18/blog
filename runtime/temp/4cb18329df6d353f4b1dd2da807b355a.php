<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"E:\wamp64\www\blog\public/../application/admin\view\category\edit.html";i:1550291043;s:59:"E:\wamp64\www\blog\application\admin\view\Public\_meta.html";i:1550228971;s:61:"E:\wamp64\www\blog\application\admin\view\Public\_footer.html";i:1550228971;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
    <form action="<?php echo url('edit'); ?>" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="cate_description"  id="cate_description" cols="" rows="" class="textarea"  placeholder="说点什么..." ><?php echo $cateInfo['cate_description']; ?></textarea>
            </div>
        </div>
