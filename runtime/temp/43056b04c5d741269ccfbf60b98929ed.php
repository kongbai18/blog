<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\wamp64\www\blog\public/../application/admin\view\label\add.html";i:1550293355;s:59:"E:\wamp64\www\blog\application\admin\view\Public\_meta.html";i:1550228971;s:61:"E:\wamp64\www\blog\application\admin\view\Public\_footer.html";i:1550228971;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<form action="<?php echo url('add'); ?>" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="label_name" name="label_name">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">标签别名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="label_alias" name="label_alias">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="label_description" id="cate_description" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)"></textarea>
			</div>
		</div>
